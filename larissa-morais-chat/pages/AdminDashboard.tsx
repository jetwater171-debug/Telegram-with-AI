...
import { Bot, Plus, Trash2, RefreshCw, MessageCircle } from 'lucide-react';
      ...
      <div className="w-full mx-auto">
        <header className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Gerencie seus bots e conversas</p>
          </div>

          <div className="flex bg-white p-1 rounded-lg border border-gray-200">
            <button
              onClick={() => setActiveTab('bots')}
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center gap-2 ${activeTab === 'bots' ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-900'}`}
            >
              <Bot size={16} />
              Meus Bots
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center gap-2 ${activeTab === 'chats' ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-900'}`}
            >
